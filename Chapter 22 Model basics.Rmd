...
1.  Family: là dạng của model muốn sử dụng, tuyến tính hay hàm số bậc hai.
...
Đầu tiên xem data set của sim1 trong modelr, gồm 2 biến x và y ở dạng continuous
