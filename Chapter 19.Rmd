...
Dùng function để giải quyết cái trường hợp cần lặp lại 1 phương thức chuyển dổi.
...
Trong Conditions chỉ có thể là TRUE hoặc FALSE, nếu dùng vector có cả TRUE lẫn FALSE, hoặc có chứ NA R sẽ báo lỗi
